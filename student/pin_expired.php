...
<body class="theme-blue-grey">
    ...
    <div class="login-box">
        <div class="logo">
        <a href="javascript:void(0);"><img src="<?php echo $set['installUrl']; ?>logo/<?php echo $set['schoolLogo']; ?>" width="80" height="80"></a>
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" >
                    ...
                    <div class="form-line">
                   <input type="password" class="form-control" name="pin" placeholder="Enter You New Pin" value=""  autocomplete="off" >
                        </div>
                    </div>
                    
                     <div class="input-group">
                    <div class="form-line">
             <input type="text" class="form-control" name="stu" value="<?php if(isset($_POST['stu'])){ echo $_POST['stu']; } ?>" placeholder="Student ID No"  autocomplete="off">
             </div>
                    </div>
                    ...
                    <div class="row">
                  <div class="col-xs-12">
                            <button name="submit" value="myrenew" class="btn btn-block bg-blue waves-effect" type="submit"><i class="glyphicon glyphicon-log-in"></i>  Continue</button>
                        </div>
                    </div>
