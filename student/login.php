...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo $set['installUrl']; ?>logo/<?php echo $set['schoolLogo']; ?>" type="image/x-icon">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" >
                    ...
                    <div class="form-line">
                   <input type="text" class="form-control" name="pin" placeholder="Enter Pin" value="<?php echo $_SESSION["pin"]; ?>" readonly  autocomplete="off" style="background:#CCC; font-weight:bold; font-size:14px;">
                        </div>
                    </div>
                    
                     <div class="input-group">
                    <div class="form-line">
             <input type="text" class="form-control" name="stu" placeholder="Student ID No"  autocomplete="off">
             </div>
                    </div>
                    ...
                    <div class="row">
                  <div class="col-xs-12">
                            <button name="submit" value="mylogin" class="btn btn-block bg-blue waves-effect" type="submit"><i class="glyphicon glyphicon-log-in"></i>  Continue</button>
                        </div>
                    </div>
...
<li><a href="<?php echo $set['instagram']; ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
    ...
    <script src="<?php echo $set['installUrl']; ?>modules/js/pages/examples/sign-in.js"></script>
</body>
