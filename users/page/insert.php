<?php
    ...
    if ($count == 0) {
		...
		(posted_by, class, page_title, page_desc, meta_keywords, meta_desc, parent, status, page_alias,post_category,post_tags, img,img_type, pdate, ptime) 
		values('$by','$class','$title', '$c', '$mk', '$md', '$present', '$sta','$alias','$cat','$tag','$pic', '$imgType', '$postedon', '$time')";
