...
if (isset($_POST["mode"]) && $_POST["mode"] == "send") {
    ...
    try {
        ...
        $mail->Subject = $subject . ' - thesoftwareguy ';
            ...
            <div id="body"> 	
                ...
                <article>
                    ...
                    <table style="width:100%" border="0">
                        <tr>
                            <td align="left"><h2><a href="index.php">Back to home page</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="testmail-gmail-smtp.php">Test mail using gmail access (smtp)</a></h2></td>
