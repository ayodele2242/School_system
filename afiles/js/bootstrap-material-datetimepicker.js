   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-clear btn btn-info hidden">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel btn btn-danger btn-sm">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok btn btn-default btn-sm">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
