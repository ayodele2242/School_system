...
<?php if($set['allowRegistrations'] =='1'){ ?>
    <a href="<?php echo $set['installUrl']; ?>student/mypin" class="btn btn-info"><i class="fa fa-user"></i> New Student Registration</a>  
   <?php }  ?>
   <a href="<?php echo $set['installUrl']; ?>student/result" class="btn btn-danger text-warning" ><i class="fa fa-scroll"></i> Check Result</a>
...
<?php if($set['allowRegistrations'] =='1'){ ?>
    <a href="<?php echo $set['installUrl']; ?>student/mypin" class="btn-info bn"><i class="fa fa-user"></i> New Student Registration</a>  
   <?php }  ?>
   <a href="<?php echo $set['installUrl']; ?>student/result" class="btn-danger bn" ><i class="fa fa-scroll"></i> Check Result</a>
