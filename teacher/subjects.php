    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form method="post" id="subjects-form">
               ...
               <input type="text" name="code" id="code" class="form-control" placeholder="Subject Code(eng for English)" />
              </div>
						</div>	
						<div class="col-md-6">
						<div class="form-group">
               <input type="text" name="name" id="name" class="form-control" placeholder="Subject Name" />
                ...
                <div align="center">
                <button type="submit" class="btn btn-md btn-info" id="btn-submit"><i class="fa fa-plus"></i> Add Subject</button>
                </div>
              </div>
            </form>
            </div>
                ...
                <div class="col-lg-7">
                <table id="subjects" class="table table_view">
                <thead class="heading">
                 <tr>
                 <th>#ID</th>
                 <th>Subject Name</th> 
