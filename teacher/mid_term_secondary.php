    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2><i class="fa fa-star"></i> Mid-Term Result</h2>
            </div>

            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                
                <form id="mid_form" class="sform">
                ...
                <th><button type="button" name="add_mid" class="btn btn-success btn-sm add_mid"><span class="glyphicon glyphicon-plus"></span> Add More</button></th>
