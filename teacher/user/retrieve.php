...
while ($row = $query->fetch_assoc()) {
	...
	<ul class="dropdown-menu">
		...
		<li class="bg-orange"><a href="edit_user?id='.$row['id'].'"><span class="glyphicon glyphicon-pencil"></span> Update Details</a></li>
		<li class="bg-red"><a href="javascript:void(0);" data-toggle="modal" data-target="#userModal" class="text text-danger" onclick="removeUser('.$row['id'].')"> <span class="glyphicon glyphicon-trash"></span> Delete Your Account</a></li>
