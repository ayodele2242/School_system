...
<input type="text" name="Roll_Number" value="" placeholder="Enter student identity number" class="form-control student">
        ...
        <?php } ?>
            ...
            <div class="col-lg-3">
		<div align="center">
       <button name="sort" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-check"></i> Check Result</button> &nbsp;<a href="javascript:void(0);" onclick="PrintElem('#printableArea')" class="btn btn-sm btn-info"><i class="fa fa-print"></i> Print</a>
       </div>
		</div>
			</form>
