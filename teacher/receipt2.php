...
<?php include('links.php'); ?>
 ...
 <div class="receipt-main col-xs-10  col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3 printable" style="background:#fff; padding:17px;" id="printableArea">
		...
		<div class="clearfix col-lg-12  col-md-12" align="center">
					<button type="input" onclick="printDiv('printableArea')" value="print" class="btn btn-info"><i class="fa fa-print"></i> Print</button>
					</div> 
