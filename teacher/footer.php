...
$(document).ready(function(){
 ...
 $(document).on('click', '.add', function(){
  ...
  html += '<td><select name="sub_id[]" class="form-control sub_id subject_code"><option value="">Select Subject</option><?php echo getTeacherSubjects(); ?></select></td>';
  ...
  html += '<td><select name="class_name[]" class="form-control class_name"><option value="">Select Class</option><?php echo getTeacherClass(); ?></select></td>';
