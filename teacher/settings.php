			...
			<form  class="form-horizontal" id="editSetting" >
				<div class="panel-body">
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-8">
							<input class="form-control" type="text" required name="schName" id="schName" value="<?php echo clean($set['school_name']); ?>" />
							<span class="help-block">This is what the people at the front end will see when visiting your school website.</span>
						</div>
					</div>
					<div class="form-group row">
				...
				<div class="media">
										...
										?>
										<img id="profile_pics"  data-holder-rendered="true" src="<?php echo $set['installUrl']; ?>logo/<?php echo $set['schoolLogo']; ?>" class="img">
										<?php
										}
										?>
												</div>
							...
							<span class="glyphicon glyphicon-camera"></span> &nbsp; Update School Logo
							</a> 
												</div>
											</div>
											</div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<span class="help-block">State where school is located</span>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<span class="help-block">Website description for SEO. e.g. school name, motto, vission etc. </span>
						</div>
					</div>
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<span class="help-block">Words that can easily be used by SEO to find your site. e.g. school name, wors related to you school or activities etc. </span>
						</div>
					</div>
...
>
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-camera"></span> Update School Logo</h4>
								<div class="media">
                                <div class="media-right">
                                    <a href="javascript:void(0);">
                                        <img class="media-object" src="../logo/photo.png" width="64" height="64">
                                    </a>
                                </div>
                                <div class="media-body">
                                    Click on the icon on the image to select the image you wish to upload.
                                </div>
                            </div>
						      </div>
		...
		<div class="bgColor">
			<form id="uploadForm" action="upload.php" method="post">
				 <div id="targetOuter">
					<div id="targetLayer"><?php if(!empty($set['schoolLogo'])){ ?> <img src="../logo/<?php echo $set['schoolLogo'];  ?>" style="min-width:100%; height:200px;"> <?php }else{ ?><img src="../logo/avatar.png" width="150px" height="150px" class="upload-preview" /><?php }?></div>
				...
				<div>
				<input type="submit" value="Upload Photo" class="btn btn-success wave-effect btn-submit" id="btn-submit" onClick="hideUploadOption();"/>
				</div>
			</form>
		</div>	
		</div>	
