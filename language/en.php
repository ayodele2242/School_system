...
$accNotFoundMsg				= "Account not found for that email address. Please check your entries.";
...
$installURLHelp				= "Used in email notifications. Must include the trailing slash. Eg. http://wwww.website.com/";
$siteNameField				= "Site Name";
$siteNameHelp				= "Appears in the Footer and other various locations throughout the Website.";
$siteEmailField				= "Site Email";
$siteLogoField				= "School Logo";
